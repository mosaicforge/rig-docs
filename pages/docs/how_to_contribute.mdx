---
title: Contributing to Rig
description: This section explains how you can contribute to Rig's ongoing development.
---
...
<div className="section-title">Contributing to Rig</div>
...
<Callout type="info" emoji="👋">
  **Prior to starting the work on a new feature or change**, make sure to search
  for existing issues and pull requests on the [GitHub
  repository](https://github.com/0xPlaygrounds/rig/issues) to discuss your ideas
  or changes. Open an issue if there is none.
</Callout>
...
<Callout type="warning" emoji="⚠️">
  Model provider integrations should not require new dependencies that are not
...
If you find a typo or mistake in the documentation, or any section that could use improvement, please open an issue to report it or a pull request to fix it on the [docs repository](https://github.com/0xPlaygrounds/rig-docs). The documentation repository also has a `CONTRIBUTING.md` file that you may find useful for understanding how to get the repo working locally.
