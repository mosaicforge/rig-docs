...
So far, we support the following integrations:

- Any text file (`FileLoader`)
- PDFs (`PdfFileLoader`)
- ePub files (`EpubFileLoader`)
...
### 1. Flexible Loading Patterns

When using the loaders, there are multiple ways to specify input sources:
