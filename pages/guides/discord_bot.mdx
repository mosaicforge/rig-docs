...
Here's an example of the bot responding to the `/ask` command:

![Bot responding to /ask command](path_to_screenshot.png)
...
Ad Astra,  
[Tachi](https://x.com/0thTachi)  
Co-Founder @ [Playgrounds Analytics](https://playgrounds.network/)
